        ...
        <Card
          ...
          cover={
            <div className='passed-games-card__container'>
              ...
              >
                <img
                  className='passed-games-card__team-logo passed-games-card__team-logo--away'
                  alt={
              ...
              >
                <img
                  className='passed-games-card__team-logo passed-games-card__team-logo--home'
                  alt={
